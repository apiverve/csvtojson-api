# CSV to JSON Converter API - Examples

This folder contains example code for using the CSV to JSON Converter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/csvtojson',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/csvtojson");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/csvtojson](https://docs.apiverve.com/ref/csvtojson)
