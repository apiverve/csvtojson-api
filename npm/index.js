...
class csvtojsonWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/csvtojson');
        }
        ...
        this.validationRules = {"csv":{"type":"string","required":true},"delimiter":{"type":"string","required":false,"default":","},"has_header":{"type":"boolean","required":false,"default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/csvtojson`);
        }
    }
...
module.exports = csvtojsonWrapper;
