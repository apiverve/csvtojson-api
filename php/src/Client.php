...
/**
 * Client for the CSV to JSON Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/csvtojson?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/csvtojson';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CsvtojsonClient] {$message}\n";
        }
    }
}
