...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/csvtojson',
        'Source': 'https://github.com/apiverve/csvtojson-api',
        'Bug Tracker': 'https://github.com/apiverve/csvtojson-api/issues'
    },
    classifiers=[
