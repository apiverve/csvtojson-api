...
namespace APIVerve.API.CSVtoJSONConverter
{
    ...
    /// <summary>
    /// Client for the CSVtoJSONConverter API
    /// </summary>
    public class CSVtoJSONConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/csvtojson";
        ...
        {
            { "csv", new ValidationRule { Type = "string", Required = true } },
            { "delimiter", new ValidationRule { Type = "string", Required = false } },
            { "has_header", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public CSVtoJSONConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CSVtoJSONConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CSVtoJSONConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CSVtoJSONConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CSVtoJSONConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(CSVtoJSONConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CSVtoJSONConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CSVtoJSONConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CSVtoJSONConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CSVtoJSONConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CSVtoJSONConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CSVtoJSONConverterQueryOptions options)
        {
