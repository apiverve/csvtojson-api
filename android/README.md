# CSV to JSON Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:csvtojson-api:1.1.12'
}
```
...
```java
import com.apiverve.csvtojson.CSVtoJSONConverterAPIClient;
import com.apiverve.csvtojson.APIResponse;
import com.apiverve.csvtojson.APIException;

// Initialize the client
CSVtoJSONConverterAPIClient client = new CSVtoJSONConverterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/csvtojson](https://docs.apiverve.com/ref/csvtojson)
...
- **Documentation:** [https://docs.apiverve.com/ref/csvtojson](https://docs.apiverve.com/ref/csvtojson)
- **Issues:** [GitHub Issues](https://github.com/apiverve/csvtojson-api/issues)
