// Package csvtojson provides a Go client for the CSV to JSON Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/csvtojson?utm_source=go&utm_medium=readme
package csvtojson
...
// Request contains the parameters for the CSV to JSON Converter API.
//
// Parameters:
//   - csv (required): string - The CSV data to convert to JSON
//   - delimiter: string - The delimiter used in the CSV
//   - has_header: boolean - Whether the first row contains column headers (default: true)
type Request struct {
	Csv string `json:"csv"` // Required
	Delimiter string `json:"delimiter,omitempty"` // Optional
	HasHeader bool `json:"has_header,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"has_header": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the CSV to JSON Converter API.
type ResponseData struct {
	RowCount int `json:"row_count"`
	ColumnCount int `json:"column_count"`
	Columns []string `json:"columns"`
	Json []JsonItem `json:"json"`
}

// JsonItem represents an item in the Json array.
